...
select vendor_id, count(*) as count_booth_rented 
...
sum(customer_purchases.quantity*customer_purchases.cost_to_customer_per_qty) as spent
from customer
...
select customer_id, sum(quantity*cost_to_customer_per_qty) as spent_money
from customer_purchases
